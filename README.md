...
- Basic control in Home Assistant: user volume & master volume (in dB), mute, source selection, preset switching, DSP toggles (loudness, EQ bypass, crossfeed, leveller), media_player entity, and track meta data.
